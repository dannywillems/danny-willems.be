...
<body id="page-top">
    ...
    <section>
        <div class="container">
            <div class="row">
              <?php
                new_card("OCaml cordova plugins bindings", "img/ocaml-cordova.png", "OCaml + Cordova", $lang['PP_OCAML_CORDOVA_PLACE'], $lang['PP_OCAML_CORDOVA_DESC'], $lang['PP_OCAML_CORDOVA_BLOG_LINK'], "");
